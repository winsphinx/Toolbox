...
class Sipcall:
    ...
    def update(self):
        ...
        content += f"ADD POOL MEDIA:SGID=15,POOLID={mgcf},MEDIA_ID=1,ML=21,MR=2104;\n"
        content += f"ADD POOL MEDIA:SGID=15,POOLID={mgcf},MEDIA_ID=2,ML=21,MR=2105;\n"
        content += f"ADD POOL MEDIA:SGID=15,POOLID={mgcf},MEDIA_ID=3,ML=21,MR=2106;\n"
        content += f"ADD POOL MEDIA:SGID=15,POOLID={mgcf},MEDIA_ID=4,ML=22,MR=2204;\n"
        content += f"ADD POOL MEDIA:SGID=15,POOLID={mgcf},MEDIA_ID=5,ML=22,MR=2205;\n"
        content += f"ADD POOL MEDIA:SGID=15,POOLID={mgcf},MEDIA_ID=6,ML=22,MR=2206;\n"
        ...
        content += f"ADD POOL MEDIA:SGID=15,POOLID={pool},MEDIA_ID=3,ML=21,MR=2103;\n"
        content += f"ADD POOL MEDIA:SGID=15,POOLID={pool},MEDIA_ID=4,ML=22,MR=2201;\n"
